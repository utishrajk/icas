...
import com.feisystems.icas.domain.reference.AdministrativeGenderCodeDataOnDemand;
import com.feisystems.icas.domain.reference.CountryCode;
import com.feisystems.icas.domain.reference.EthnicGroupCodeDataOnDemand;
import com.feisystems.icas.domain.reference.LanguageCodeDataOnDemand;
import com.feisystems.icas.domain.reference.MaritalStatusCodeDataOnDemand;
import com.feisystems.icas.domain.reference.RaceCodeDataOnDemand;
import com.feisystems.icas.domain.reference.ReligiousAffiliationCodeDataOnDemand;
...
public class PatientDataOnDemand {
	...
	public void init() {
        int pageNumber = 0;
        int pageSize = 10;
        data =  patientRepository.findAll(new PageRequest(pageNumber, pageSize)).getContent();
        if (data == null) {
