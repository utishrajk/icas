...
public class MailSenderServiceImpl implements MailSenderService {
	...
	public EmailServiceTokenModel sendVerificationEmail(final EmailServiceTokenModel emailVerificationModel) {
		...
		return sendVerificationEmail(emailVerificationModel, config.getEmailVerificationSubjectText(), "META-INF/velocity/VerifyEmail.vm", resources);
	}
	...
	public EmailServiceTokenModel sendLostPasswordEmail(final EmailServiceTokenModel emailServiceTokenModel) {
		Map<String, String> resources = new HashMap<String, String>();
		return sendVerificationEmail(emailServiceTokenModel, config.getLostPasswordSubjectText(), "META-INF/velocity/LostPasswordEmail.vm", resources);
	}
	...
	public EmailServiceTokenModel sendLostPasswordAndSecurityQuestionsEmail(final EmailServiceTokenModel emailServiceTokenModel) {
		Map<String, String> resources = new HashMap<String, String>();
		return sendVerificationEmail(emailServiceTokenModel, config.getLostPasswordSubjectText(), "META-INF/velocity/LostPasswordAndSecurityQuestionsEmail.vm", resources);
	}
